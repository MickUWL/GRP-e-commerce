...
<head>
    ...
    <title>Home - Love Fruit &amp; Veg</title>
...
<body>
    ...
    <main class="page landing-page">
        <section class="clean-block clean-hero" style="background-image: url(&quot;assets/img/project/background.jpg&quot;);color: rgba(9,162,255,0);opacity: 1;">
            <h2 class="text-info" style="height: 80px;background-color: rgba(255,255,255,0.68);font-size: 60px;width: 1280px;">Fresh Produce for Fresh People</h2>
        </section>
        <section class="clean-block clean-info dark">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6"><img class="img-thumbnail" src="assets/img/project/backgroundinfo.jpg"></div>
                    <div class="col-md-6">
                        <h3>Not customers, but a community</h3>
                        <div class="getting-started-info">
                            <p>Here at LFV we believe that we are more than just a retailer, we believe in supporting our local farming communities by providing you, our community with a fast and fresh online ordering experience&nbsp;</p>
                        </div><a class="btn btn-outline-primary btn-lg" role="button" href="registration.html">Join Now</a></div>
                </div>
            </div>
        </section>
    </main>
