            ...
            <div class="container">
                <div class="block-content">
                    <div class="product-info">
                        <div class="row">
                            <div class="col-md-6" style="padding: 0px 0px;color: rgb(255,255,255);opacity: 1;"><img style="width: 450px;height: 510px;margin: 0px;color: rgba(255,255,255,0);" src="assets/img/basket-3.jpg"></div>
                            <div class="col-md-6" style="width: 300px;">
                                <form name="add_to_cart" action="cart.php" method="post">
                                    <div class="info">
                                        <h3>Apple Basket - Granny Smith<br></h3> <input type="hidden" value="Apple basket" name="product">
                                        <div class="price">
                                            ...
                                            <button
                                                class="btn btn-primary" type="submit" style="margin: 0px 0px ;" name="add_to_cart"><i class="icon-basket"></i>Add to Cart</button><input class="bg-white form-control form-control no-border" type="hidden" style="width: 110px;" value="item code:"
                                                    readonly=""><input class="bg-white form-control form-control no-border" type="hidden" style="width: 110px;" value="23" name="item_code" readonly=""></div>
                                        <p style="margin: 0px 0px 2px;">Enter quantity</p><input class="form-control quantity-input" type="number" value="1" name="qty">
                                        <div class="summary">
                                            <p style="margin: 0px;">How do you like dem apples?</p>
                                            <br>
                                            <p style="margin: 0px;">You're an apple person and that's ok, select this basket for a large supply of apples made up of approx 20 apples,&nbsp; making a 20% saving rather than ordering our 4 packs...and a nice basket included!!!</p>
                                            <br>
                                            <p style="margin: 0px;">Vendor - Granny Smith</p>
                                        </div>
                                    </div>
                                </form>
                            </div>
