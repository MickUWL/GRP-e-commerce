            ...
            <div class="container">
                <div class="block-content">
                    <div class="product-info">
                        <div class="row">
                            <div class="col-md-6" style="padding: 0px 0px;color: rgb(255,255,255);opacity: 1;"><img style="width: 450px;height: 510px;margin: 0px;color: rgba(255,255,255,0);" src="assets/img/project/11%20-%20Grapes.jpg"></div>
                            <div class="col-md-6" style="width: 300px;">
                                <form name="add_to_cart" action="cart.php" method="post">
                                    <div class="info">
                                        <h3>Grapes - Grape Direct<br></h3> <input type="hidden" value="Grapes" name="product">
                                        <div class="price">
                                            ...
                                            <button
                                                class="btn btn-primary" type="submit" style="margin: 0px 0px ;" name="add_to_cart"><i class="icon-basket"></i>Add to Cart</button><input class="bg-white form-control form-control no-border" type="hidden" style="width: 110px;" value="item code:"
                                                    readonly=""><input class="bg-white form-control form-control no-border" type="hidden" style="width: 110px;" value="11" name="item_code" readonly=""></div>
                                        <p style="margin: 0px 0px 2px;">Enter quantity</p><input class="form-control quantity-input" type="number" value="1" name="qty">
                                        <div class="summary">
                                            <p style="margin: 0px;">250g seedless grapes</p>
                                            <br>
                                            <p style="margin: 0px;">Vendor - Grape Direct</p>
                                        </div>
                                    </div>
                                </form>
                            </div>
